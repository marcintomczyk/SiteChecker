...
class Site(models.Model):
    ...
    original_address = models.URLField(max_length=200, null=True, blank=True)
    final_address = models.URLField(max_length=200, null=True, blank=True)
    status_code = models.PositiveSmallIntegerField()
    check_date = models.DateTimeField('check date')
    error_message = models.TextField(max_length=400, null=True)
